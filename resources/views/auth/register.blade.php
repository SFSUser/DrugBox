            ...
            <div class="card" style="max-width: 500px;margin:auto;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="documentType" class="col-md-4 col-form-label text-md-right">Tipo documento</label>

                            <div class="col-md-6">
                                <select id="documentType" type="number" class="form-control @error('documentType') is-invalid @enderror" name="documentType" value="{{ old('documentType') }}" required autocomplete="documentType" autofocus>
